...
public class TrainService {
    ...
    private static final String TRAIN_DB_PATH = "C:\\Users\\ashjh\\OneDrive\\Desktop\\IRCTC\\app\\src\\main\\java\\ticket\\booking\\localDb\\trains.json";
    ...
    private boolean validTrain(Train train, String source, String destination) {
        List<String> stationOrder = train.getStations()
                .stream()
                .map(String::toLowerCase) // Normalize station names
    ...
    public Train getTrainById(String trainId) throws IOException {
        List<Train> trains = loadTrainsFromFile(); // Or however you're loading trains
    ...
    private List<Train> loadTrainsFromFile() throws IOException {
